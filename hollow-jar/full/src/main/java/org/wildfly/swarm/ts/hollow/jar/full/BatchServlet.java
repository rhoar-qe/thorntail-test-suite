...
public class BatchServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } else if (operation.equals("batchStatus")) {
            String id = req.getParameter("id");
            JobExecution jobExecution = BatchRuntime.getJobOperator().getJobExecution(Long.parseLong(id));
            resp.getWriter().print(jobExecution.getBatchStatus());
