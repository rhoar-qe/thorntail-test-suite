...
@DefaultDeployment
public class MicroProfileMetrics20Test {
    @Test
    @RunAsClient
    @InSequence(1)
    public void applicationMetricsAreRegisteredAtDeploymentTime() throws IOException {
        ...
        assertThat(app.has("hello-invocations")).isTrue();
    }
    ...
    public void trigger() throws IOException {
        ...
        assertThat(response).isEqualTo("Hello from counted and timed and metered and concurrent-gauged method");

        response = Request.Get("http://localhost:8080/another-hello").execute().returnContent().asString();
        assertThat(response).isEqualTo("Hello from another counted method");
    ...
    public void jsonMetadata() throws IOException {
        ...
        assertThat(app.has("hello-invocations")).isTrue();
        assertThat(app.getAsJsonObject("hello-invocations").get("displayName").getAsString()).isEqualTo("Hello Invocations");
        assertThat(app.getAsJsonObject("hello-invocations").get("description").getAsString()).isEqualTo("Number of current hello invocations");
        assertThat(app.getAsJsonObject("hello-invocations").get("unit").getAsString()).isEqualTo("none");
    }
    ...
    public void jsonData() throws IOException {
        ...
        JsonObject app = json.getAsJsonObject("application");
        assertThat(app.has("hello-count")).isTrue();
        assertThat(app.get("hello-count").getAsInt()).isEqualTo(12); // 11 at `/` + 1 at `/another-hello`
        assertThat(app.has("hello-time")).isTrue();
        ...
        assertThat(app.has("hello-invocations")).isTrue();
        assertThat(app.getAsJsonObject("hello-invocations").get("current").getAsInt()).isEqualTo(0);
    }
    ...
    public void prometheusData() throws IOException {
        ...
        assertThat(response).contains("application_hello_count_total 12.0");
        assertThat(response).contains("application_hello_time_seconds_count 11.0");
        assertThat(prometheusMetricValue(response, "application_hello_time_min_seconds"))
        ...
        assertThat(prometheusMetricValue(response, "application_hello_time_max_seconds"))
                .isGreaterThanOrEqualTo(0.001)
                .isLessThanOrEqualTo(0.110); // delay is from 1 to 100 millis, 10 millis should be enough of a tolerance
        assertThat(response).contains("application_hello_freq_total 11.0");
        assertThat(response).contains("application_hello_invocations_current 0.0");
    }
    ...
    public void metricRegistryInjection() throws IOException {
        ...
        assertThat(base.contains(new JsonPrimitive("classloader.loadedClasses.count"))).isTrue();
        assertThat(base.contains(new JsonPrimitive("classloader.loadedClasses.total"))).isTrue();
        assertThat(base.contains(new JsonPrimitive("classloader.unloadedClasses.total"))).isTrue();
        ...
        assertThat(app.contains(new JsonPrimitive("hello-invocations"))).isTrue();
    }
    ...
    public void getAllRegisteredMetricsOfGivenType() throws IOException {
        ...
        assertThat(json.has("app-concurrent-gauges")).isTrue();
        JsonArray appConcurrentGauges = json.getAsJsonArray("app-concurrent-gauges");
        assertThat(appConcurrentGauges.size()).isEqualTo(1);
        assertThat(appConcurrentGauges.contains(new JsonPrimitive("hello-invocations"))).isTrue();
